...
export const RecentProjects = () => {
  return (
    <div id="projects" className="py-20">
      ...
      justify-center p-4 gap-x-24 gap-y-32 mt-10"
      >
              ...
              <div className="flex items-center justify-between mt-7 mb-3">
                <div className="flex items-center">
                  {iconLists.map((icon, index) => (
                    <div
                      key={index}
                      className="border border-white/[0.2] rounded-full bg-black lg:bg-black-10 lg:h-10 w-8 h-8 flex justify-center items-center"
                      style={{
